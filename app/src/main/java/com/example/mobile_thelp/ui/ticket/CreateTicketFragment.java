    ...
    private void submitTicket() {
        ...
        if (isOfflineMode) {
            ...
            new Handler().postDelayed(() -> {
                ...
                Toast.makeText(getContext(), "Chamado Simulado Criado com Sucesso!", Toast.LENGTH_SHORT).show();
            ...
            // Código para API real iria aqui
            Toast.makeText(getContext(), "Modo Online desativado", Toast.LENGTH_SHORT).show();
            btnSubmit.setEnabled(true);
            btnSubmit.setText("Abrir Chamado");
        }
    }
